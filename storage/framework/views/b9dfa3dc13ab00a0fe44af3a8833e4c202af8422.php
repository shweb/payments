...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/css/mediaqueries.css">
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/css/animate.css">
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/public/css/font-awesome.css">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <img src="<?php echo e(url('/')); ?>/public/img/alipay.png">
                </a>

                <a class="navbar-brand" href="#">
                    <img src="<?php echo e(url('/')); ?>/public/img/wechat.png">
                </a>
            </div>
        ...
        <div class="bg-custom">
            <div class="row">
                <div class="col-md-6 col-xs-12 text-center-md text-center-xs">
                    ...
                    <?php endif; ?>
                    <img src="<?php echo e(url('/')); ?>/public/img/communicate.png" class="img-thumbnail communicate"
                         width="304" height="236">
                </div>


                <div class="col-md-6 col-xs-12 text-center-md text-center-xs">
                    <img src="<?php echo e(url('/')); ?>/public/img/phone.png" class="img-thumbnail" width="400" height="236">
                </div>
            </div>
